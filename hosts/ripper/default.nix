...

{
  ...
  networking.hostName = "nix-ripper";
  ...
  services.autorandr = {
    enable = true;
    defaultTarget = "twoDisplaysAMDProWX3300";
  };
  ...
  environment.etc = {
    ...
    "smb-secrets".text = pkgs.lib.mkForce ''
      username=larusso
      password=Ohy9quai
    '';
  };
  ...
  fileSystems."/mnt/sabnzbd-downloads" = {
      device = "//192.168.188.147/Downloads";
      fsType = "cifs";
      options = let
